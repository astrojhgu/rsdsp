...
use rsdsp::{
    ampl_resp::ampl_resp_2stages_1freq2,
...
pub fn main() {
    ...
    let (coeff_coarse,_) =
        pfb_coeff::<FloatType>(nch_coarse, tap_coarse, 1.55*k_coarse as FloatType).into_raw_vec_and_offset();
    let (coeff_fine,_) =
    ...
    fine_spec
        ...
        .for_each(|((mut fine_resp, mut coarse_resp), freq)| {
            ...
            let (coarse_resp1, fine_resp1) = ampl_resp_2stages_1freq2(
                nch_coarse,
                nch_fine,
                &coeff_coarse,
                &coeff_fine,
